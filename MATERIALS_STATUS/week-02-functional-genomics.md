...
| Speaker scripts | `05-scripts/...` | pending | Text-only slide content now exists; next step is lecturer scripts. |
...
- Review text-only slide content, then generate lecturer scripts for Lecture 1 as the next pilot step.
