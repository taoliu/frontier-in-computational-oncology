...
| L1-05 | Background is structured | Local genomic background and assay bias control false discovery. | Signal/background cartoon | S001, S007, S014 | draft |
| L1-06 | Reproducibility is part of the model | QC, blacklist filtering, and replicate handling are not optional post-processing. | QC pipeline schematic | S002, S007, S013, S014 | draft |
...
| L2-09 | Verification toolkit | IDR, benchmarks, calibration checks, orthogonal evidence, and perturbation evidence serve different roles. | Evidence ladder | S007, S013, S015 | draft |
...
| L3-03 | TF cistrome rewiring | Cancer can rewire TF binding without changing the TF itself. | AR cistrome concept figure | S016 | draft |
| L3-04 | Super-enhancer states | Enhancer landscapes can define tumor regulatory identities. | Super-enhancer state map | S017 | draft |
| L3-05 | Enhancer hijacking | SVs can activate oncogenes by rewiring regulatory context. | Enhancer hijacking cartoon | S018, S019 | draft |
...
| W02-A005 | L3-05 | Original schematic | Enhancer hijacking mechanism using medulloblastoma and leukemia examples. | Created in-house with S018/S019 citations | needed |
